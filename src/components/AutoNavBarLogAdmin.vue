  ...
  <nav class="navbar navbar-expand-lg bg-dark navbar-dark shadow-sm">
    <div class="container-fluid">
      ...
      <div ref="popoverContainer">
        <button @click="togglePopover" class="btn user-btn d-flex align-items-center">
          <img
...
import { getAdminById } from "@/services/service.js";

const userData = ref({});
const showPopover = ref(false);
const popoverContainer = ref(null);

userData.value = await getAdminById(sessionStorage.adminId);
